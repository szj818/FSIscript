...
DatamodelRoot().CouplingParticipant[FLUID].ExecutionControl.InitialInput = 'fluidFlow.jou'

DatamodelRoot().CouplingParticipant[FLUID].ExecutionControl.AdditionalArguments = '-mpi=intel'
