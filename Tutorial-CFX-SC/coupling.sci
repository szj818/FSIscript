<SystemCoupling Ver="1">
  <Participants Count="2">
    ...
    <Participant Ver="1" Type="0">
      ...
      <ParticipantType PropType="string">CFX</ParticipantType>
      <SupportsCouplingIterations PropType="bool">True</SupportsCouplingIterations>
      <UnitSystem PropType="string">SI</UnitSystem>
      <Regions Count="2">
        <Region Ver="1">
          <Name PropType="string">Default Domain Default</Name>
          <DisplayName PropType="string">Default Domain Default</DisplayName>
          <TopologicalDimensionality PropType="int">3</TopologicalDimensionality>
        </Region>
        <Region Ver="1">
      ...
      <Variables Count="2">
        <Variable Ver="1">
          <Name PropType="string">Total Force</Name>
          <DisplayName PropType="string">Force</DisplayName>
          <PhysicalType PropType="string">Force</PhysicalType>
        </Variable>
        <Variable Ver="1">
          <Name PropType="string">Mesh Displacement</Name>
          <DisplayName PropType="string">Mesh Displacement</DisplayName>
          <PhysicalType PropType="string">Length</PhysicalType>
        </Variable>
      </Variables>
  ...
  <Transfers Count="2">
    <Transfer Ver="1">
      ...
      <Target Ver="1">
        ...
        <Variable PropType="string">Mesh Displacement</Variable>
      </Target>
    ...
    <Transfer Ver="1">
      ...
      <Source Ver="1">
        <Participant PropType="string">Solution 1</Participant>
        <Region PropType="string">wall_deforming</Region>
        <Variable PropType="string">Total Force</Variable>
      </Source>
      <Target Ver="1">
        <Participant PropType="string">Solution</Participant>
        <Region PropType="string">FSIN_1</Region>
  ...
  <ExecutionControl Ver="0">
    ...
    <IntermediateResultFileOutput Ver="1">
      <FrequencyOption PropType="int">2<!--0=None, 1=Every Step, 2=Step Interval--></FrequencyOption>
      <StepInterval PropType="int">5</StepInterval>
